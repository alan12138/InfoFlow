	...
	for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
                ...
                [playButton setImage:[UIImage imageNamed:@"动态视频播放"] forState:UIControlStateNormal];
                [playButton setImage:[UIImage imageNamed:@"动态视频播放"] forState:UIControlStateHighlighted];
